...
statement_list:
    statement_list M statement { complete($1,$2);
                                 $$ = $3; }
  | statement { $$ = $1; }
  ;
...
statement:
    ...
    bidon { gencode("instruction bidon");
             }
...
/*    ID EQUAL NUM
  ...
  | */
    TRUE { $$.true = crelist(nextquad);
           gencode("goto");
           $$.false = NULL; }
  | FALSE { $$.false = crelist(nextquad);
           gencode("goto");
           $$.true = NULL; }
